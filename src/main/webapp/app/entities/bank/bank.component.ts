...
export class BankComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    this.bankService
      ...
      .subscribe((res: HttpResponse<IBank[]>) => this.paginateBanks(res.body, res.headers));
  }
  ...
  registerChangeInBanks(): void {
    this.eventSubscriber = this.eventManager.subscribe('bankListModification', () => this.reset());
  }
  ...
  protected paginateBanks(data: IBank[] | null, headers: HttpHeaders): void {
