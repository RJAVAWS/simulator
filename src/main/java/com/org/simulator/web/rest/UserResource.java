...
import com.org.simulator.web.rest.errors.EmailAlreadyUsedException;
import com.org.simulator.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
     ...
     */
    @GetMapping("/users/bankKeyValueMap")
    @PreAuthorize("hasRole(\"" + AuthoritiesConstants.ADMIN + "\")")
    public Map<Long, String> getBankKeyValueMap() {
        return userService.getBankKeyValueMap();
    }
