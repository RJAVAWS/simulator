...
import { EmvComponent } from 'app/entities/emv/emv.component';
import { EmvService } from 'app/entities/emv/emv.service';
import { Emv } from 'app/shared/model/emv.model';

describe('Component Tests', () => {
  describe('Emv Management Component', () => {
    let comp: EmvComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.emvs && comp.emvs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
