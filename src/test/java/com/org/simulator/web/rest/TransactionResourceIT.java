...
import com.org.simulator.repository.TransactionRepository;
import com.org.simulator.service.TransactionService;
import com.org.simulator.service.dto.TransactionDTO;
import com.org.simulator.service.mapper.TransactionMapper;
...
public class TransactionResourceIT {
    ...
    private static final AcqIssType DEFAULT_TRAN_TYPE = AcqIssType.ACQUIRING;
    private static final AcqIssType UPDATED_TRAN_TYPE = AcqIssType.ISSUING;
    ...
    private static final String DEFAULT_ISO_MSG = "AAAAAAAAAA";
    private static final String UPDATED_ISO_MSG = "BBBBBBBBBB";
    ...
    public void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getMti()).isEqualTo(DEFAULT_MTI);
        assertThat(testTransaction.getDe001()).isEqualTo(DEFAULT_DE_001);
        assertThat(testTransaction.getDe002()).isEqualTo(DEFAULT_DE_002);
        assertThat(testTransaction.getDe003()).isEqualTo(DEFAULT_DE_003);
        assertThat(testTransaction.getDe004()).isEqualTo(DEFAULT_DE_004);
        assertThat(testTransaction.getDe005()).isEqualTo(DEFAULT_DE_005);
        assertThat(testTransaction.getDe006()).isEqualTo(DEFAULT_DE_006);
        assertThat(testTransaction.getDe007()).isEqualTo(DEFAULT_DE_007);
        assertThat(testTransaction.getDe008()).isEqualTo(DEFAULT_DE_008);
        assertThat(testTransaction.getDe009()).isEqualTo(DEFAULT_DE_009);
        assertThat(testTransaction.getDe010()).isEqualTo(DEFAULT_DE_010);
        assertThat(testTransaction.getDe011()).isEqualTo(DEFAULT_DE_011);
        assertThat(testTransaction.getDe012()).isEqualTo(DEFAULT_DE_012);
        assertThat(testTransaction.getDe013()).isEqualTo(DEFAULT_DE_013);
        assertThat(testTransaction.getDe014()).isEqualTo(DEFAULT_DE_014);
        assertThat(testTransaction.getDe015()).isEqualTo(DEFAULT_DE_015);
        assertThat(testTransaction.getDe016()).isEqualTo(DEFAULT_DE_016);
        assertThat(testTransaction.getDe017()).isEqualTo(DEFAULT_DE_017);
        assertThat(testTransaction.getDe018()).isEqualTo(DEFAULT_DE_018);
        assertThat(testTransaction.getDe019()).isEqualTo(DEFAULT_DE_019);
        assertThat(testTransaction.getDe020()).isEqualTo(DEFAULT_DE_020);
        assertThat(testTransaction.getDe021()).isEqualTo(DEFAULT_DE_021);
        assertThat(testTransaction.getDe022()).isEqualTo(DEFAULT_DE_022);
        assertThat(testTransaction.getDe023()).isEqualTo(DEFAULT_DE_023);
        assertThat(testTransaction.getDe024()).isEqualTo(DEFAULT_DE_024);
        assertThat(testTransaction.getDe025()).isEqualTo(DEFAULT_DE_025);
        assertThat(testTransaction.getDe026()).isEqualTo(DEFAULT_DE_026);
        assertThat(testTransaction.getDe027()).isEqualTo(DEFAULT_DE_027);
        assertThat(testTransaction.getDe028()).isEqualTo(DEFAULT_DE_028);
        assertThat(testTransaction.getDe029()).isEqualTo(DEFAULT_DE_029);
        assertThat(testTransaction.getDe030()).isEqualTo(DEFAULT_DE_030);
        assertThat(testTransaction.getDe031()).isEqualTo(DEFAULT_DE_031);
        assertThat(testTransaction.getDe032()).isEqualTo(DEFAULT_DE_032);
        assertThat(testTransaction.getDe033()).isEqualTo(DEFAULT_DE_033);
        assertThat(testTransaction.getDe034()).isEqualTo(DEFAULT_DE_034);
        assertThat(testTransaction.getDe035()).isEqualTo(DEFAULT_DE_035);
        assertThat(testTransaction.getDe036()).isEqualTo(DEFAULT_DE_036);
        assertThat(testTransaction.getDe037()).isEqualTo(DEFAULT_DE_037);
        assertThat(testTransaction.getDe038()).isEqualTo(DEFAULT_DE_038);
        assertThat(testTransaction.getDe039()).isEqualTo(DEFAULT_DE_039);
        assertThat(testTransaction.getDe040()).isEqualTo(DEFAULT_DE_040);
        assertThat(testTransaction.getDe041()).isEqualTo(DEFAULT_DE_041);
        assertThat(testTransaction.getDe042()).isEqualTo(DEFAULT_DE_042);
        assertThat(testTransaction.getDe043()).isEqualTo(DEFAULT_DE_043);
        assertThat(testTransaction.getDe044()).isEqualTo(DEFAULT_DE_044);
        assertThat(testTransaction.getDe045()).isEqualTo(DEFAULT_DE_045);
        assertThat(testTransaction.getDe046()).isEqualTo(DEFAULT_DE_046);
        assertThat(testTransaction.getDe047()).isEqualTo(DEFAULT_DE_047);
        assertThat(testTransaction.getDe048()).isEqualTo(DEFAULT_DE_048);
        assertThat(testTransaction.getDe049()).isEqualTo(DEFAULT_DE_049);
        assertThat(testTransaction.getDe050()).isEqualTo(DEFAULT_DE_050);
        assertThat(testTransaction.getDe051()).isEqualTo(DEFAULT_DE_051);
        assertThat(testTransaction.getDe052()).isEqualTo(DEFAULT_DE_052);
        assertThat(testTransaction.getDe053()).isEqualTo(DEFAULT_DE_053);
        assertThat(testTransaction.getDe054()).isEqualTo(DEFAULT_DE_054);
        assertThat(testTransaction.getDe055()).isEqualTo(DEFAULT_DE_055);
        assertThat(testTransaction.getDe056()).isEqualTo(DEFAULT_DE_056);
        assertThat(testTransaction.getDe057()).isEqualTo(DEFAULT_DE_057);
        assertThat(testTransaction.getDe058()).isEqualTo(DEFAULT_DE_058);
        assertThat(testTransaction.getDe059()).isEqualTo(DEFAULT_DE_059);
        assertThat(testTransaction.getDe060()).isEqualTo(DEFAULT_DE_060);
        assertThat(testTransaction.getDe061()).isEqualTo(DEFAULT_DE_061);
        assertThat(testTransaction.getDe062()).isEqualTo(DEFAULT_DE_062);
        assertThat(testTransaction.getDe063()).isEqualTo(DEFAULT_DE_063);
        assertThat(testTransaction.getDe064()).isEqualTo(DEFAULT_DE_064);
        assertThat(testTransaction.getDe065()).isEqualTo(DEFAULT_DE_065);
        assertThat(testTransaction.getDe066()).isEqualTo(DEFAULT_DE_066);
        assertThat(testTransaction.getDe067()).isEqualTo(DEFAULT_DE_067);
        assertThat(testTransaction.getDe068()).isEqualTo(DEFAULT_DE_068);
        assertThat(testTransaction.getDe069()).isEqualTo(DEFAULT_DE_069);
        assertThat(testTransaction.getDe070()).isEqualTo(DEFAULT_DE_070);
        assertThat(testTransaction.getDe071()).isEqualTo(DEFAULT_DE_071);
        assertThat(testTransaction.getDe072()).isEqualTo(DEFAULT_DE_072);
        assertThat(testTransaction.getDe073()).isEqualTo(DEFAULT_DE_073);
        assertThat(testTransaction.getDe074()).isEqualTo(DEFAULT_DE_074);
        assertThat(testTransaction.getDe075()).isEqualTo(DEFAULT_DE_075);
        assertThat(testTransaction.getDe076()).isEqualTo(DEFAULT_DE_076);
        assertThat(testTransaction.getDe077()).isEqualTo(DEFAULT_DE_077);
        assertThat(testTransaction.getDe078()).isEqualTo(DEFAULT_DE_078);
        assertThat(testTransaction.getDe079()).isEqualTo(DEFAULT_DE_079);
        assertThat(testTransaction.getDe080()).isEqualTo(DEFAULT_DE_080);
        assertThat(testTransaction.getDe081()).isEqualTo(DEFAULT_DE_081);
        assertThat(testTransaction.getDe082()).isEqualTo(DEFAULT_DE_082);
        assertThat(testTransaction.getDe083()).isEqualTo(DEFAULT_DE_083);
        assertThat(testTransaction.getDe084()).isEqualTo(DEFAULT_DE_084);
        assertThat(testTransaction.getDe085()).isEqualTo(DEFAULT_DE_085);
        assertThat(testTransaction.getDe086()).isEqualTo(DEFAULT_DE_086);
        assertThat(testTransaction.getDe087()).isEqualTo(DEFAULT_DE_087);
        assertThat(testTransaction.getDe088()).isEqualTo(DEFAULT_DE_088);
        assertThat(testTransaction.getDe089()).isEqualTo(DEFAULT_DE_089);
        assertThat(testTransaction.getDe090()).isEqualTo(DEFAULT_DE_090);
        assertThat(testTransaction.getDe091()).isEqualTo(DEFAULT_DE_091);
        assertThat(testTransaction.getDe092()).isEqualTo(DEFAULT_DE_092);
        assertThat(testTransaction.getDe093()).isEqualTo(DEFAULT_DE_093);
        assertThat(testTransaction.getDe094()).isEqualTo(DEFAULT_DE_094);
        assertThat(testTransaction.getDe095()).isEqualTo(DEFAULT_DE_095);
        assertThat(testTransaction.getDe096()).isEqualTo(DEFAULT_DE_096);
        assertThat(testTransaction.getDe097()).isEqualTo(DEFAULT_DE_097);
        assertThat(testTransaction.getDe098()).isEqualTo(DEFAULT_DE_098);
        assertThat(testTransaction.getDe099()).isEqualTo(DEFAULT_DE_099);
        assertThat(testTransaction.getDe100()).isEqualTo(DEFAULT_DE_100);
        assertThat(testTransaction.getDe101()).isEqualTo(DEFAULT_DE_101);
        assertThat(testTransaction.getDe102()).isEqualTo(DEFAULT_DE_102);
        assertThat(testTransaction.getDe103()).isEqualTo(DEFAULT_DE_103);
        assertThat(testTransaction.getDe104()).isEqualTo(DEFAULT_DE_104);
        assertThat(testTransaction.getDe105()).isEqualTo(DEFAULT_DE_105);
        assertThat(testTransaction.getDe106()).isEqualTo(DEFAULT_DE_106);
        assertThat(testTransaction.getDe107()).isEqualTo(DEFAULT_DE_107);
        assertThat(testTransaction.getDe108()).isEqualTo(DEFAULT_DE_108);
        assertThat(testTransaction.getDe109()).isEqualTo(DEFAULT_DE_109);
        assertThat(testTransaction.getDe110()).isEqualTo(DEFAULT_DE_110);
        assertThat(testTransaction.getDe111()).isEqualTo(DEFAULT_DE_111);
        assertThat(testTransaction.getDe112()).isEqualTo(DEFAULT_DE_112);
        assertThat(testTransaction.getDe113()).isEqualTo(DEFAULT_DE_113);
        assertThat(testTransaction.getDe114()).isEqualTo(DEFAULT_DE_114);
        assertThat(testTransaction.getDe115()).isEqualTo(DEFAULT_DE_115);
        assertThat(testTransaction.getDe116()).isEqualTo(DEFAULT_DE_116);
        assertThat(testTransaction.getDe117()).isEqualTo(DEFAULT_DE_117);
        assertThat(testTransaction.getDe118()).isEqualTo(DEFAULT_DE_118);
        assertThat(testTransaction.getDe119()).isEqualTo(DEFAULT_DE_119);
        assertThat(testTransaction.getDe120()).isEqualTo(DEFAULT_DE_120);
        assertThat(testTransaction.getDe121()).isEqualTo(DEFAULT_DE_121);
        assertThat(testTransaction.getDe122()).isEqualTo(DEFAULT_DE_122);
        assertThat(testTransaction.getDe123()).isEqualTo(DEFAULT_DE_123);
        assertThat(testTransaction.getDe124()).isEqualTo(DEFAULT_DE_124);
        assertThat(testTransaction.getDe125()).isEqualTo(DEFAULT_DE_125);
        assertThat(testTransaction.getDe126()).isEqualTo(DEFAULT_DE_126);
        assertThat(testTransaction.getDe127()).isEqualTo(DEFAULT_DE_127);
        assertThat(testTransaction.getDe128()).isEqualTo(DEFAULT_DE_128);
        assertThat(testTransaction.getIsoMsg()).isEqualTo(DEFAULT_ISO_MSG);
    }
    ...
    public void getAllTransactions() throws Exception {
        ...
        restTransactionMockMvc.perform(get("/api/transactions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].isoMsg").value(hasItem(DEFAULT_ISO_MSG.toString())));
    }
    ...
    public void getTransaction() throws Exception {
        ...
        restTransactionMockMvc.perform(get("/api/transactions/{id}", transaction.getId()))
            ...
            .andExpect(jsonPath("$.isoMsg").value(DEFAULT_ISO_MSG.toString()));
    }
    ...
    public void updateTransaction() throws Exception {
        ...
        assertThat(testTransaction.getMti()).isEqualTo(UPDATED_MTI);
        assertThat(testTransaction.getDe001()).isEqualTo(UPDATED_DE_001);
        assertThat(testTransaction.getDe002()).isEqualTo(UPDATED_DE_002);
        assertThat(testTransaction.getDe003()).isEqualTo(UPDATED_DE_003);
        assertThat(testTransaction.getDe004()).isEqualTo(UPDATED_DE_004);
        assertThat(testTransaction.getDe005()).isEqualTo(UPDATED_DE_005);
        assertThat(testTransaction.getDe006()).isEqualTo(UPDATED_DE_006);
        assertThat(testTransaction.getDe007()).isEqualTo(UPDATED_DE_007);
        assertThat(testTransaction.getDe008()).isEqualTo(UPDATED_DE_008);
        assertThat(testTransaction.getDe009()).isEqualTo(UPDATED_DE_009);
        assertThat(testTransaction.getDe010()).isEqualTo(UPDATED_DE_010);
        assertThat(testTransaction.getDe011()).isEqualTo(UPDATED_DE_011);
        assertThat(testTransaction.getDe012()).isEqualTo(UPDATED_DE_012);
        assertThat(testTransaction.getDe013()).isEqualTo(UPDATED_DE_013);
        assertThat(testTransaction.getDe014()).isEqualTo(UPDATED_DE_014);
        assertThat(testTransaction.getDe015()).isEqualTo(UPDATED_DE_015);
        assertThat(testTransaction.getDe016()).isEqualTo(UPDATED_DE_016);
        assertThat(testTransaction.getDe017()).isEqualTo(UPDATED_DE_017);
        assertThat(testTransaction.getDe018()).isEqualTo(UPDATED_DE_018);
        assertThat(testTransaction.getDe019()).isEqualTo(UPDATED_DE_019);
        assertThat(testTransaction.getDe020()).isEqualTo(UPDATED_DE_020);
        assertThat(testTransaction.getDe021()).isEqualTo(UPDATED_DE_021);
        assertThat(testTransaction.getDe022()).isEqualTo(UPDATED_DE_022);
        assertThat(testTransaction.getDe023()).isEqualTo(UPDATED_DE_023);
        assertThat(testTransaction.getDe024()).isEqualTo(UPDATED_DE_024);
        assertThat(testTransaction.getDe025()).isEqualTo(UPDATED_DE_025);
        assertThat(testTransaction.getDe026()).isEqualTo(UPDATED_DE_026);
        assertThat(testTransaction.getDe027()).isEqualTo(UPDATED_DE_027);
        assertThat(testTransaction.getDe028()).isEqualTo(UPDATED_DE_028);
        assertThat(testTransaction.getDe029()).isEqualTo(UPDATED_DE_029);
        assertThat(testTransaction.getDe030()).isEqualTo(UPDATED_DE_030);
        assertThat(testTransaction.getDe031()).isEqualTo(UPDATED_DE_031);
        assertThat(testTransaction.getDe032()).isEqualTo(UPDATED_DE_032);
        assertThat(testTransaction.getDe033()).isEqualTo(UPDATED_DE_033);
        assertThat(testTransaction.getDe034()).isEqualTo(UPDATED_DE_034);
        assertThat(testTransaction.getDe035()).isEqualTo(UPDATED_DE_035);
        assertThat(testTransaction.getDe036()).isEqualTo(UPDATED_DE_036);
        assertThat(testTransaction.getDe037()).isEqualTo(UPDATED_DE_037);
        assertThat(testTransaction.getDe038()).isEqualTo(UPDATED_DE_038);
        assertThat(testTransaction.getDe039()).isEqualTo(UPDATED_DE_039);
        assertThat(testTransaction.getDe040()).isEqualTo(UPDATED_DE_040);
        assertThat(testTransaction.getDe041()).isEqualTo(UPDATED_DE_041);
        assertThat(testTransaction.getDe042()).isEqualTo(UPDATED_DE_042);
        assertThat(testTransaction.getDe043()).isEqualTo(UPDATED_DE_043);
        assertThat(testTransaction.getDe044()).isEqualTo(UPDATED_DE_044);
        assertThat(testTransaction.getDe045()).isEqualTo(UPDATED_DE_045);
        assertThat(testTransaction.getDe046()).isEqualTo(UPDATED_DE_046);
        assertThat(testTransaction.getDe047()).isEqualTo(UPDATED_DE_047);
        assertThat(testTransaction.getDe048()).isEqualTo(UPDATED_DE_048);
        assertThat(testTransaction.getDe049()).isEqualTo(UPDATED_DE_049);
        assertThat(testTransaction.getDe050()).isEqualTo(UPDATED_DE_050);
        assertThat(testTransaction.getDe051()).isEqualTo(UPDATED_DE_051);
        assertThat(testTransaction.getDe052()).isEqualTo(UPDATED_DE_052);
        assertThat(testTransaction.getDe053()).isEqualTo(UPDATED_DE_053);
        assertThat(testTransaction.getDe054()).isEqualTo(UPDATED_DE_054);
        assertThat(testTransaction.getDe055()).isEqualTo(UPDATED_DE_055);
        assertThat(testTransaction.getDe056()).isEqualTo(UPDATED_DE_056);
        assertThat(testTransaction.getDe057()).isEqualTo(UPDATED_DE_057);
        assertThat(testTransaction.getDe058()).isEqualTo(UPDATED_DE_058);
        assertThat(testTransaction.getDe059()).isEqualTo(UPDATED_DE_059);
        assertThat(testTransaction.getDe060()).isEqualTo(UPDATED_DE_060);
        assertThat(testTransaction.getDe061()).isEqualTo(UPDATED_DE_061);
        assertThat(testTransaction.getDe062()).isEqualTo(UPDATED_DE_062);
        assertThat(testTransaction.getDe063()).isEqualTo(UPDATED_DE_063);
        assertThat(testTransaction.getDe064()).isEqualTo(UPDATED_DE_064);
        assertThat(testTransaction.getDe065()).isEqualTo(UPDATED_DE_065);
        assertThat(testTransaction.getDe066()).isEqualTo(UPDATED_DE_066);
        assertThat(testTransaction.getDe067()).isEqualTo(UPDATED_DE_067);
        assertThat(testTransaction.getDe068()).isEqualTo(UPDATED_DE_068);
        assertThat(testTransaction.getDe069()).isEqualTo(UPDATED_DE_069);
        assertThat(testTransaction.getDe070()).isEqualTo(UPDATED_DE_070);
        assertThat(testTransaction.getDe071()).isEqualTo(UPDATED_DE_071);
        assertThat(testTransaction.getDe072()).isEqualTo(UPDATED_DE_072);
        assertThat(testTransaction.getDe073()).isEqualTo(UPDATED_DE_073);
        assertThat(testTransaction.getDe074()).isEqualTo(UPDATED_DE_074);
        assertThat(testTransaction.getDe075()).isEqualTo(UPDATED_DE_075);
        assertThat(testTransaction.getDe076()).isEqualTo(UPDATED_DE_076);
        assertThat(testTransaction.getDe077()).isEqualTo(UPDATED_DE_077);
        assertThat(testTransaction.getDe078()).isEqualTo(UPDATED_DE_078);
        assertThat(testTransaction.getDe079()).isEqualTo(UPDATED_DE_079);
        assertThat(testTransaction.getDe080()).isEqualTo(UPDATED_DE_080);
        assertThat(testTransaction.getDe081()).isEqualTo(UPDATED_DE_081);
        assertThat(testTransaction.getDe082()).isEqualTo(UPDATED_DE_082);
        assertThat(testTransaction.getDe083()).isEqualTo(UPDATED_DE_083);
        assertThat(testTransaction.getDe084()).isEqualTo(UPDATED_DE_084);
        assertThat(testTransaction.getDe085()).isEqualTo(UPDATED_DE_085);
        assertThat(testTransaction.getDe086()).isEqualTo(UPDATED_DE_086);
        assertThat(testTransaction.getDe087()).isEqualTo(UPDATED_DE_087);
        assertThat(testTransaction.getDe088()).isEqualTo(UPDATED_DE_088);
        assertThat(testTransaction.getDe089()).isEqualTo(UPDATED_DE_089);
        assertThat(testTransaction.getDe090()).isEqualTo(UPDATED_DE_090);
        assertThat(testTransaction.getDe091()).isEqualTo(UPDATED_DE_091);
        assertThat(testTransaction.getDe092()).isEqualTo(UPDATED_DE_092);
        assertThat(testTransaction.getDe093()).isEqualTo(UPDATED_DE_093);
        assertThat(testTransaction.getDe094()).isEqualTo(UPDATED_DE_094);
        assertThat(testTransaction.getDe095()).isEqualTo(UPDATED_DE_095);
        assertThat(testTransaction.getDe096()).isEqualTo(UPDATED_DE_096);
        assertThat(testTransaction.getDe097()).isEqualTo(UPDATED_DE_097);
        assertThat(testTransaction.getDe098()).isEqualTo(UPDATED_DE_098);
        assertThat(testTransaction.getDe099()).isEqualTo(UPDATED_DE_099);
        assertThat(testTransaction.getDe100()).isEqualTo(UPDATED_DE_100);
        assertThat(testTransaction.getDe101()).isEqualTo(UPDATED_DE_101);
        assertThat(testTransaction.getDe102()).isEqualTo(UPDATED_DE_102);
        assertThat(testTransaction.getDe103()).isEqualTo(UPDATED_DE_103);
        assertThat(testTransaction.getDe104()).isEqualTo(UPDATED_DE_104);
        assertThat(testTransaction.getDe105()).isEqualTo(UPDATED_DE_105);
        assertThat(testTransaction.getDe106()).isEqualTo(UPDATED_DE_106);
        assertThat(testTransaction.getDe107()).isEqualTo(UPDATED_DE_107);
        assertThat(testTransaction.getDe108()).isEqualTo(UPDATED_DE_108);
        assertThat(testTransaction.getDe109()).isEqualTo(UPDATED_DE_109);
        assertThat(testTransaction.getDe110()).isEqualTo(UPDATED_DE_110);
        assertThat(testTransaction.getDe111()).isEqualTo(UPDATED_DE_111);
        assertThat(testTransaction.getDe112()).isEqualTo(UPDATED_DE_112);
        assertThat(testTransaction.getDe113()).isEqualTo(UPDATED_DE_113);
        assertThat(testTransaction.getDe114()).isEqualTo(UPDATED_DE_114);
        assertThat(testTransaction.getDe115()).isEqualTo(UPDATED_DE_115);
        assertThat(testTransaction.getDe116()).isEqualTo(UPDATED_DE_116);
        assertThat(testTransaction.getDe117()).isEqualTo(UPDATED_DE_117);
        assertThat(testTransaction.getDe118()).isEqualTo(UPDATED_DE_118);
        assertThat(testTransaction.getDe119()).isEqualTo(UPDATED_DE_119);
        assertThat(testTransaction.getDe120()).isEqualTo(UPDATED_DE_120);
        assertThat(testTransaction.getDe121()).isEqualTo(UPDATED_DE_121);
        assertThat(testTransaction.getDe122()).isEqualTo(UPDATED_DE_122);
        assertThat(testTransaction.getDe123()).isEqualTo(UPDATED_DE_123);
        assertThat(testTransaction.getDe124()).isEqualTo(UPDATED_DE_124);
        assertThat(testTransaction.getDe125()).isEqualTo(UPDATED_DE_125);
        assertThat(testTransaction.getDe126()).isEqualTo(UPDATED_DE_126);
        assertThat(testTransaction.getDe127()).isEqualTo(UPDATED_DE_127);
        assertThat(testTransaction.getDe128()).isEqualTo(UPDATED_DE_128);
        assertThat(testTransaction.getIsoMsg()).isEqualTo(UPDATED_ISO_MSG);
    }
